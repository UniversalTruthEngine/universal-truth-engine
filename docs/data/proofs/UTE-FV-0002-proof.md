...
They are not materially identical, but their quantities are equal.
...
If two expressions are equal in value, one may replace the other where only that value matters.
